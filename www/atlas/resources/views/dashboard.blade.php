...
<div id="dashboard-content" class="content-panel p-6 md:p-8">
    ...
    <div id="quick-links-container" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {{-- Kartu WO CNSD --}}
        <div class="quick-link-card bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
            <a href="{{ route('wo.cnsd.index') }}" class="quick-link flex flex-col justify-between h-full" aria-label="Lihat Work Order CNSD">
                <div>
                    <div class="flex items-center justify-between mb-4">
        ...
        {{-- Kartu WO TFP --}}
        <div class="quick-link-card bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
            <a href="{{ route('wo.tfp.index') }}" class="quick-link flex flex-col justify-between h-full" aria-label="Lihat Work Order TFP">
                <div>
                    <div class="flex items-center justify-between mb-4">
        ...
        {{-- Kartu Meter Reading --}}
        <div class="quick-link-card bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
            <a href="#" class="quick-link flex flex-col justify-between h-full" aria-label="Buka Meter Reading">
                <div>
                    <div class="flex items-center justify-between mb-4">
                    ...
                    <h4 class="text-lg font-semibold text-gray-800">Meter Reading</h4>
